= IRC Client Library for Arduino image:https://travis-ci.org/fredimachado/ArduinoIRC.svg?branch=master["Build Status", link="https://travis-ci.org/Fredi/ArduinoIRC"]
